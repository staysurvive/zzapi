          ...
          if (loading) {
            ...
            valueContent = (
              <>
                ...
                <div className='workspace-supporting-text text-muted-foreground/40 mt-1 hidden text-xs md:block'>
                  {it.desc}
                </div>
              </>
            )
            ...
            valueContent = (
              <>
                ...
                <div className='workspace-supporting-text text-muted-foreground/60 mt-1 hidden text-xs md:block'>
                  {it.desc}
                </div>
              </>
            )
