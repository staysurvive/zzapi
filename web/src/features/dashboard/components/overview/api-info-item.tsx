      ...
      <div className='flex min-w-0 flex-1 items-center gap-2 sm:gap-3'>
        ...
        <div className='flex min-w-0 flex-1 flex-col gap-0.5'>
          <div className='flex items-baseline gap-2'>
            ...
            <span className='workspace-supporting-text text-muted-foreground/60 hidden truncate text-xs md:inline'>
              {item.description}
            </span>
          </div>
          <span className='workspace-supporting-text text-muted-foreground/40 truncate font-mono text-xs'>
            {item.url}
          </span>
        </div>
      </div>
