 ...
 * but the only Chinese resource uses the non-standard `zhCN` code. Every
 * Chinese variant intentionally resolves to Simplified Chinese; other
 * unsupported interface locales resolve to English.
 */
 ...
 * through this before it reaches an `Intl` constructor. Every non-Chinese value
 * intentionally uses English so formatting cannot drift to an unsupported locale.
 */
